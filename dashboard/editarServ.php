...
<?php
    ...
    $sentencia = $bd->prepare("select * from servicios where codigo = ?;");
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="editarProcesoServ.php">
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php echo $servicios->Responsable; ?>">
                    </div>
                    <div class="d-grid">
                        <input type="hidden" name="codigo" value="<?php echo $servicios->codigo; ?>">

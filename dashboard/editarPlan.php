...
<?php
    ...
    $sentencia = $bd->prepare("select * from planeacion where codigo = ?;");
    $sentencia->execute([$codigo]);
    $planeacion = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($planeacion);
?>

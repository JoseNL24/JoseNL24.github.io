...
<?php
    ...
    $sentencia = $bd->prepare("select * from conciliador where codigo = ?;");
    $sentencia->execute([$codigo]);
    $conciliador = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($conciliador);
?>

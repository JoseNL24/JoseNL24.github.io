  ...
  <body>
      <div class="container-fluid bg-primary">
          <div class="row">
              <div class="col-md">
                  <header class="py-3">
                      <h3 class="text-center">Coordinación de Ecología y Medio Ambiente</h3>
                  </header>
              </div>
          </div>
      </div>
...
<?php
    ...
    $sentencia = $bd -> query("select * from ecologia");
    $ecologia = $sentencia->fetchAll(PDO::FETCH_OBJ);
    //print_r($ecologia);
?>
    ...
    <div class="row justify-content">
                    ...
                    <table class="table table-striped table-bordered table-condensed" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="text-success" href="editarEco.php?codigo=<?php echo $dato->codigo; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminarEco.php?codigo=<?php echo $dato->codigo; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrarEco.php">
                    <div class="mb-3">

...
<?php
    ...
    $sentencia = $bd->prepare("select * from dif where codigo = ?;");
    $sentencia->execute([$codigo]);
    $dif = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($dif);
?>

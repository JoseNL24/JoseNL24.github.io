...
<?php
    ...
    $sentencia = $bd->prepare("select * from mujer where codigo = ?;");
    $sentencia->execute([$codigo]);
    $mujer = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($mujer);
?>

...
<?php
    ...
    $sentencia = $bd->prepare("select * from obras where codigo = ?;");
    $sentencia->execute([$codigo]);
    $obras = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($obras);
?>

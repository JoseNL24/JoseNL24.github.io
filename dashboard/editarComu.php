...
<?php
    ...
    $sentencia = $bd->prepare("select * from comunicacion where codigo = ?;");
    $sentencia->execute([$codigo]);
    $comunicacion = $sentencia->fetch(PDO::FETCH_OBJ);

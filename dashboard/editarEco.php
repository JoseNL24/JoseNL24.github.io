...
<?php
    ...
    $sentencia = $bd->prepare("select * from ecologia where codigo = ?;");
    $sentencia->execute([$codigo]);
    $ecologia = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($ecologia);
?>

...
<?php
    ...
    $sentencia = $bd->prepare("select * from biblioteca where codigo = ?;");
    $sentencia->execute([$codigo]);
    $biblioteca = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($biblioteca);
?>

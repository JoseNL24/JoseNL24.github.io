...
<?php
    ...
    $sentencia = $bd->prepare("select * from agropecuario where codigo = ?;");
    $sentencia->execute([$codigo]);
    $agropecuario = $sentencia->fetch(PDO::FETCH_OBJ);

...
<?php
    ...
    $sentencia = $bd->prepare("select * from tesoreria where codigo = ?;");
    $sentencia->execute([$codigo]);
    $tesoreria = $sentencia->fetch(PDO::FETCH_OBJ);
    //print_r($tesoreria);
?>
